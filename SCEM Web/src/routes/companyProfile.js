...
import {doc, setDoc, collection, getDocs, query, where, getDoc, updateDoc, addDoc} from "firebase/firestore";
        ...
        <form id="companyProfile-form" onSubmit={handleSave}>
            <div>
                <div id={"companyProfile-inputBoxes"}>
                    ...
                    <select id="companyProfile-Input" placeholder="Account type" defaultValue={"User"}
                            onChange={(e) => {
